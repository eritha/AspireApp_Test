...
//        js.executeScript("arguments[0].click();", e);
    ...
    /*
     * Wait for a element is clickable
     */
    public void waitForElementClickable(String locator) {
        WebDriverWait waitVisible = new WebDriverWait(driver, 30);
        waitVisible.until(ExpectedConditions.elementToBeClickable(byLocator(locator)));
    }
    ...
    /*
     * Set text element by JavascriptExecutor
     */
    public void addTextToElementByJavaScript(String locator, String text) {
...
//        ((JavascriptExecutor) driver).executeScript("arguments[0].setAttribute('value','28/02')", newElement);
    ...
    /*
     * Focus element by JavascriptExecutor
     */
    public void focusElementByJavaScript(String locator) {
        WebElement element = findElement(locator);
        JavascriptExecutor js = (JavascriptExecutor) driver;
    ...
    /*
     * Action perform to input OTP
     */
    public void inputValueByActionPerform(String value) {
        Actions action = new Actions(driver);
        try {
            action.sendKeys(value).build().perform();
        } catch (NoSuchElementException ex) {
            Result.checkFail("Class Helper | Method inputValueByActionPerform | Exception desc : " + ex.getMessage());
        }
    }

    /*
     * Clear text for web element
     */
    public void clearWebField(String locator) {
        WebElement element = findElement(locator);
...
//        element.sendKeys(Keys.chord(Keys.CONTROL,"a", Keys.DELETE));
     ...
     * Press keyboard TAB
     */
    public void pressTabByActionPerform() {
        Actions action = new Actions(driver);
        try {
            action.sendKeys(Keys.TAB).build().perform();
        } catch (NoSuchElementException ex) {
            Result.checkFail("Class Helper | Method pressTabByActionPerform | Exception desc : " + ex.getMessage());
        }
    }
