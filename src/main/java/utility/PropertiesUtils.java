...
public class PropertiesUtils {
    ...
    public static String aspireUrl;
    ...
    public static void readGlobalPropertyFile() {
        ...
        accountPhone = getPropertyValue(globalPro, Constants.Phone);
        environmentTest = getPropertyValue(globalPro, Constants.environment);
        aspireUrl = getPropertyValue(globalPro, environmentTest.concat(Constants.Aspire_Web_Url));
